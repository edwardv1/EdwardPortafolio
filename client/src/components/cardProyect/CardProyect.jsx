    ...
    return(
        <div>
            ...
            <div class=" bg-none w-[380px] h-[126px] sm:w-[420px] xl:w-[500px] xl:h-[350px]">
                ...
                <div class=" bg-whitesmoke grid grid-col-[30%,70%] w-[380px] sm:w-[420px] h-[90px] sm:h-[100px] xl:w-[500px] xl:h-[110px] rounded-bl-[10px] rounded-br-[10px]">
                    ...
                    <div class="flex justify-between h-[50px] pl-6 pr-6 pt-2 sm:pt-0 items-center text-base xl:text-xl xl:pt-3">
                        <p>{props.date}</p>
                        <div class="flex">
